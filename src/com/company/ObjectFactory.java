...
public class ObjectFactory {
    ...
    private final static QName _MultResponse_QNAME = new QName("http://company.com/", "multResponse");
    private final static QName _Mult_QNAME = new QName("http://company.com/", "mult");
    private final static QName _Add_QNAME = new QName("http://company.com/", "add");
    private final static QName _AddResponse_QNAME = new QName("http://company.com/", "addResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://company.com/", name = "multResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://company.com/", name = "mult")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://company.com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://company.com/", name = "addResponse")
